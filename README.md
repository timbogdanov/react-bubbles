...
- [ ] Explain what a token is used for.
      a token is used to athenticate a user and grant permission for viewing editing deleting and adding.
- [ ] What steps can you take in your web apps to keep your data secure?
      require users to register and login. generate a token and grant permissions above if token is present
- [ ] Describe how web servers work.
      client sends http request to server -> server responds with data -> data is sent back to the client
